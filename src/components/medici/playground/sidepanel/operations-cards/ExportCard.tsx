...
import ChooseActorDialog from "./dialogs/ChooseActorDialog";
...
const ExportCard: React.FunctionComponent<{ selected: any, accordionExpanded: Accordions, setAccordionExpanded: (v: Accordions) => void }> = ({
  ...
  const [selectedValueTo, setSelectedValueActor] = React.useState<Trader | null>(
    null
  );
...
//   open: boolean;
//   setSelectedValueActor: (v: Trader) => void;
//   onClose: () => void;
//   selectedTraders: any[];
// }

// function ToDialog(props: ToDialogProps) {
//   const { onClose, setSelectedValueActor, open, selectedTraders } = props;
